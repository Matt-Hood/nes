...
const card = (props) => {
  const {
    eyebrow, logo, title, titleH2, body, componentPosition, textAlignment = 'left', logoPosition, logoName, logoNameAttribution, primary, secondary, showRating, background = '#14153b'
  } = props
    ...
    <CardContent>
{
  ...
  <LanguageIcon sx={{ marginLeft: '.7rem'}}/>
      ...
      <Typography variant="h5" component="div"  sx={{ padding: '1rem 0', fontWeight: 'bold', paddingTop: '1.5rem', fontWeight: '900' }}>
        {title}
      </Typography >
